...
mkdir -p StructureResults_K1_6
structure_threader run -K 6 -R 5 -i populations.snps.filter2.0.25.recode.singlesnp.str -o StructureResults_K1_6 \
                        --ind indfile -t 4 -st /usr/local/share/Structure2.3.4_console
