...
#--------------------------------------------------------------------------------------
#trace plots
load("./byPop_run1_LongRun/byPop_run1_space_MCMC_output1.Robj")
...
#   sample covariance.
load("./byPop_run1_LongRun/byPop_run1_MCN.frequencies.list.Robj")
...
sample.colors <- rainbow(n=15,start=4/6,end=6/6)[as.numeric(cut(sm_data_pop$population.coordinates[,1],15))]
...
#   of the MCMC.
example.spacemix.map.list <- make.spacemix.map.list(MCMC.output.file = "./byPop_run1_LongRun/byPop_run1_space_MCMC_output1.Robj",
...
make.spacemix.map(spacemix.map.list = example.spacemix.map.list,
                  text=TRUE,
                  ellipses=T,
                  source.option=F, xlim=c(-10,1), ylim=c(48, 58))

example.spacemix.map.listm4 <- make.spacemix.map.list(MCMC.output.file = "./byPop_noadmixture_run1_LongRun/byPop_noadmixture_run1_space_MCMC_output1.Robj",
                                                    geographic.locations = sm_data_pop$population.coordinates,
                                                    name.vector = coords$POP,
                                                    color.vector = sample.colors,
                                                    quantile=0.95,
