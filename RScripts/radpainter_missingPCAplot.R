...
setwd("/media/data_disk/PROJECTS/Saad/CommonBlue/stacks.denovo/stacks_m4_M4_n4_new/populations.r50.p15_moh_0.65/RadPainter/miss75neutral/")
...
lane2$lane <- "2"
library(tidyverse)
lane2$V2 <- str_replace_all(lane2$V2, "RNL", "CFW")
...
col <- funky(2)
mind <- read.delim("haps_radpainter_reordered_missingness.out")
names(mind)<- str_replace_all(names(mind), "RNL", "CFW")
