...
system("ln -s ../../populations.snps.filter2.0.25.recode.neutral.vcf .")
#convert vcf to phylip
system("python /opt/vcf2phylip/vcf2phylip.py -i  populations.snps.filter2.0.25.recode.neutral.vcf -n ")
...
system("raxml-ng --parse --msa populations.snps.filter2.0.5.recode.min4_BInoIinv.phy --model GTR+G+ASC_LEWIS --prefix T2")
#2infer trees --outgroup FRN_m_M05,FRN_f_M02,FRN_m_M03,FRN_f_M04,FRN_m_M06,FRN_m_M07
system("raxml-ng --msa  populations.snps.filter2.0.5.recode.min4_BInoIinv.phy --model GTR+G+ASC_LEWIS  --prefix T4 --threads 4 --seed 2 --tree pars{25},rand{25}")
#3check differences in topology
#system("raxml-ng --rfdist --tree T4.raxml.mlTrees --prefix RF")
#4bootstrapping with 1000 trees
system("raxml-ng --bootstrap --msa populations.snps.filter2.0.5.recode.min4_BInoIinv.phy --model GTR+G+ASC_LEWIS  --prefix BS1000 --seed 2 --threads 6 --bs-trees 1000")
